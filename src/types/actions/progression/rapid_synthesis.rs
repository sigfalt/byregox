...
use crate::types::{traits::{ProgressAction, CraftingAction, GeneralAction}, enums::{CraftingJob, ActionType, Buff, StepState}, Simulation};
...
impl GeneralAction for RapidSynthesis {
	fn get_potency(&self, simulation_state: &Simulation) -> u32 {
		if simulation_state.crafter_stats.level >= 63 { 500 } else { 250 }
	}
